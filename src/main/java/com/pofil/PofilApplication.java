...
import com.pofil.repository.BankCardInfoRepository;
...
public class PofilApplication {
	...
	CommandLineRunner init(RoleRepository roleRepository, FileSystemStorageService storageService, 
			CustomUserDetailsService userDetailsService, BankCardInfoRepository bankCardInfoRepository) {
	    return args -> {
	    	...
	    	if(bankCardInfo == null) {
	    		BankCardInfo newBankCardInfo = new BankCardInfo();
	    		newBankCardInfo.setBankName("Pokhara Finance Ltd.");
	    		newBankCardInfo.setbIN("62347712");
	    		newBankCardInfo.setOldBin("637029");
